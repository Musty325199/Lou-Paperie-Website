  ...
  return (
    <div className="flex flex-col items-center gap-5 justify-center mt-5 md:mt-0 md:m-[4.5rem] md:w-[90%]">
        <div className='w-full px-5 flex items-center gap-10 flex-col'>
            ...
            <div className='w-full md:px-0 mr-10 md:mr-0 px-5 gap-10 py-10 grid sm:grid-cols-2 md:grid-cols-4 grid-cols-1'>
                {
        ...
        <div className='w-full md:px-0 px-5 gap-5 py-10 grid sm:grid-cols-2  md:grid-cols-2 grid-cols-1'>
        <a href='/blog' className='flex flex-col gap-5 cursor-pointer'>
          ...
          <h3 className='text-3xl sm:text-xl font-semibold'>Stories & Guides</h3>
          <p>Read Our Blog</p>
          </div>
        </a>
        ...
        <a href='/shop' className='flex flex-col gap-5 cursor-pointer'>
          ...
          <div className='font-roboto  text-gray-700 flex items-center flex-col'>
          <h3 className='text-3xl sm:text-xl font-semibold'>Our Products</h3>
          <p>Shop Now</p>
          </div>
        </a>
        </div>
